...
class PlaceUserFeedbackByIdResponse {
  final bool isSuccess;
  final String? message;
  final PlaceUserFeedbackByIdData? data;
  final List<String>? errors;
  final String? errorCode;

  PlaceUserFeedbackByIdResponse({
  ...
  factory PlaceUserFeedbackByIdResponse.fromJson(Map<String, dynamic> json) {
    return PlaceUserFeedbackByIdResponse(
      isSuccess: json['isSuccess'] ?? false,
      message: json['message'],
      data: json['data'] != null
          ? PlaceUserFeedbackByIdData.fromJson(json['data'])
          : null,
...
class PlaceUserFeedbackByIdData {
  final int totalPlacesCommented;
  final List<PlaceUserFeedbackByIdItem> feedbacks;

  PlaceUserFeedbackByIdData({
    required this.totalPlacesCommented,
    required this.feedbacks,
  });

  factory PlaceUserFeedbackByIdData.fromJson(Map<String, dynamic> json) {
    return PlaceUserFeedbackByIdData(
      totalPlacesCommented: json['totalPlacesCommented'] ?? 0,
      feedbacks: (json['feedbacks'] as List<dynamic>? ?? [])
          .map((e) => PlaceUserFeedbackByIdItem.fromJson(e))
          .toList(),
    );
  }
}

class PlaceUserFeedbackByIdItem {
  final int id;
  final int userId;
  final int placeDbId;
  ...
  factory PlaceUserFeedbackByIdItem.fromJson(Map<String, dynamic> json) {
    return PlaceUserFeedbackByIdItem(
      id: json['id'] ?? 0,
