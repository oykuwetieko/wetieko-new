...
class PlaceFeedbackListResponse {
  final bool isSuccess;
  final String? message;
  final List<PlaceFeedbackItem> data;
  final List<String>? errors;
  final String? errorCode;

  PlaceFeedbackListResponse({
  ...
  factory PlaceFeedbackListResponse.fromJson(Map<String, dynamic> json) {
    return PlaceFeedbackListResponse(
      isSuccess: json['isSuccess'] ?? false,
      message: json['message'],
      data: (json['data'] as List<dynamic>? ?? [])
          .map((e) => PlaceFeedbackItem.fromJson(e))
          .toList(),
...
class PlaceFeedbackItem {
  ...
  factory PlaceFeedbackItem.fromJson(Map<String, dynamic> json) {
    return PlaceFeedbackItem(
      id: json['id'] ?? 0,
